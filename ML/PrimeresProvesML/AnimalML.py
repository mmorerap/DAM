...
# --- Dades d'entrenament ---
# Característiques: [pel/noPel(1/0), pes en kg]

X = [[1, 1], [1, 7], [1, 9], [1, 30],
     [0, 0.1], [0, 1], [0, 2], [0, 30],]
y = ["Gat", "Gat", "Gos", "Gos",
     "Ocell", "Ocell", "Gallina", "Gallina",]
...
parser = argparse.ArgumentParser(description="Classificador de d'animals amb ML")
parser.add_argument("rodes", type=int, help="Te pel (1 o 0)")
parser.add_argument("pes", type=int, help="Pes del animal(kg)")
